...
namespace PantryPlusRecipe.Migrations
{
    ...
    [Migration("20220914190237_HelloFreshSpiceBlend")]
    partial class HelloFreshSpiceBlend
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PantryPlusRecipe.Models.Cart", b =>
                {
                    ...
                    b.Property<string>("KrogerCategory")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
                    ...
                    b.Property<string>("SearchTermWhenAdded")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("PantryPlusRecipe.Models.Favorite", b =>
                {
            ...
            modelBuilder.Entity("PantryPlusRecipe.Models.HelloFreshSpiceBlend", b =>
                {
                    b.Property<int>("HelloFreshSpiceBlendId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("HelloFreshSpiceBlendName")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.HasKey("HelloFreshSpiceBlendId");

                    b.ToTable("HelloFreshSpiceBlends");
                });

            modelBuilder.Entity("PantryPlusRecipe.Models.HelloFreshSpiceBlendIngredient", b =>
                {
                    b.Property<int>("HelloFreshSpiceBlendIngredientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("HelloFreshSpiceBlendIngredientId");

                    b.HasIndex("HelloFreshSpiceBlendId");

                    b.HasIndex("IngredientId");

                    b.ToTable("HelloFreshSpiceBlendIngredients");
                });

            modelBuilder.Entity("PantryPlusRecipe.Models.HelloFreshToken", b =>
                {
                    b.Property<int>("HelloFreshTokenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PantryPlusRecipe.Models.Ingredient", b =>
                {
                    ...
                    b.Property<string>("CountForAPIRecipe")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");
            ...
            modelBuilder.Entity("PantryPlusRecipe.Models.HelloFreshSpiceBlendIngredient", b =>
                {
                    b.HasOne("PantryPlusRecipe.Models.HelloFreshSpiceBlend", "HelloFreshSpiceBlend")
                        .WithMany("JoinEntities")
                        .HasForeignKey("HelloFreshSpiceBlendId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("HelloFreshSpiceBlend");
